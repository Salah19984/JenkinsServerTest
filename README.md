...
Github Branch stattfindet, auch ein Build ausgelöst wird. Das ist eine ressourcenschonende Möglichkeit, um den Build zu automatisieren. Dazu muss das Github Plugin   installiert sein und der Jenkins Server muss aus dem Internet erreichbar sein.  
